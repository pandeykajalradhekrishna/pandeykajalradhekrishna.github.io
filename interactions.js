...
(() => {
  ...
  const knowledge = [
    {
      ...
      answer: "Kajal’s niche is AI—specifically research-grounded enterprise intelligence. She has led conversational AI and NLP products across 3–5M daily queries, helped evolve structured fact retrieval toward RAG and agent-assisted workflows, shaped recommendation and Next Best Action concepts, and built platform strategy for reusable, governed AI. Her differentiator is combining AI product judgment with analytics, experimentation, human-centered research, and responsible scale."
    },
    {
    ...
    {
      terms: ["agent", "agents", "agentic", "rag", "retrieval", "grounding", "mcp", "tool use", "tool calling"],
      answer: "Kajal’s conversational-AI experience includes the evolution from structured fact retrieval into retrieval-augmented generation, grounding and evaluation, and agent-assisted workflows. Her product practice extends into agentic orchestration, permissioned tool use, reusable enterprise capabilities, and MCP-aware interoperability—paired with human oversight, outcome metrics, and governance."
    },
    {
  ...
  const suggestionDeck = [
    ...
    ["What is her RAG experience?", "How has she worked with AI agents?", "Where does MCP fit in her practice?"]
  ];
